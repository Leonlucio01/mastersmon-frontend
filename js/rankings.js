...
function configurarIdiomaRanking() {
    ...
    if (!languageSelect || typeof getCurrentLang !== "function") return;
...
function configurarEventosRanking() {
    document.addEventListener("usuarioSesionActualizada", () => {
        // Hook reservado por si luego quieres refrescar cosas privadas del ranking.
    });
}
            ...
            <div class="ranking-list-main">
                ...
                <div class="ranking-list-text">
                    ...
                    <div class="ranking-list-subline">
                        ...
                        <span class="ranking-pill">${t("ranking_type")}: ${escapeHtml(traducirTipoPokemonMapsSegura(item?.tipo || "—"))}</span>
...
function traducirTipoPokemonMapsSegura(tipo = "") {
