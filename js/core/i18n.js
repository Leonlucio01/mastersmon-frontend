...
const TRANSLATIONS = {
  en: {
    ...
    home: {
      title: "Trainer hub",
      body: "Pick up your run, review your team, and jump back into the world.",
      ...
      completion: "Pokedex progress",
      noTeam: "Your active team is still empty.",
      noAlerts: "Everything looks calm. You're ready to explore.",
      ...
      activeBenefits: "Active alerts",
      teamPower: "Team power",
      walletsEmpty: "No wallets available yet."
    },
    ...
    common: { trainer: "Trainer", loading: "Loading...", error: "Something went wrong.", levelShort: "Lv" }
  },
  es: {
    ...
    home: {
      title: "Centro del entrenador",
      body: "Retoma tu progreso, revisa tu equipo y vuelve al mundo en segundos.",
      ...
      nextGym: "Siguiente gym",
      captured: "Capturados",
      shiny: "Shiny",
      trainerLevel: "Nivel entrenador",
      completion: "Progreso Pokédex",
      noTeam: "Tu equipo activo todavía está vacío.",
      noAlerts: "Todo está en calma. Estás listo para explorar.",
      openCollection: "Abrir colección",
      openTeam: "Abrir equipo",
      openGyms: "Abrir gyms",
      openShop: "Abrir tienda",
      region: "Región",
      upcomingGoal: "Próximo objetivo",
      activeBenefits: "Alertas activas",
      teamPower: "Poder del equipo",
      walletsEmpty: "Todavía no hay monedas disponibles."
    },
    ...
    common: { trainer: "Entrenador", loading: "Cargando...", error: "Algo salió mal.", levelShort: "Nv" }
  }
};
